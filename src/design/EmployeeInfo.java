...
public class EmployeeInfo implements Employee {
    ...
    public static int calculateEmployeePension() {
        ...
        String [] joinedDate = convertedJoiningDate.split("/");
        String [] todayDate = convertedTodaysDate.split("/");
        int numYears = Integer.parseInt(todayDate[1]) - Integer.parseInt(joinedDate[1]);
