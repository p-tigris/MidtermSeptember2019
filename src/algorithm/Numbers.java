...
public class Numbers {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Total Execution Time of " + num.length + " numbers in Selection Sort take: " + quickSortExecutionTime + " milli sec");
        connectToSqlDB.insertDataFromArrayToSqlTable(num, "selection_sort", "SortingNumbers");
        ...
        algo.bucketSort(num, num.length - 1);
        ...
        //The best sorting algorithm is quickSort because it has the fastest time
